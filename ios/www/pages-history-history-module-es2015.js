...
/* harmony import */ var _fivethree_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @fivethree/core */ "./node_modules/@fivethree/core/fesm2015/fivethree-core.js");
...
/* harmony import */ var _app_bar_app_bar_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../app-bar/app-bar.module */ "./src/app/app-bar/app-bar.module.ts");
...
HistoryPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _app_bar_app_bar_module__WEBPACK_IMPORTED_MODULE_8__["FivAppBarModule"],
            _fivethree_core__WEBPACK_IMPORTED_MODULE_5__["FivIconModule"],
            _fivethree_core__WEBPACK_IMPORTED_MODULE_5__["FivFabModule"],
...
let HistoryPage = class HistoryPage {
    constructor(router, logService, afs, storage, modalController, afStorage, alertController) {
        this.router = router;
                            ...
                            for (let i = 0; i < dates.entries.length; ++i) {
                                if (dates.entries[i].modality === "foodImg") {
                                    dates.entries[i].entry = this.afStorage
                                        .ref(this.logService.username + "/" + ele.entries[i].entry)
                                        .getDownloadURL();
                                }
                            }
                            // entry.push(dates);

...
const routes = [
    ...
    { path: 'entry', loadChildren: () => __webpack_require__.e(/*! import() | pages-entry-entry-module */ "pages-entry-entry-module").then(__webpack_require__.bind(null, /*! ./pages/entry/entry.module */ "./src/app/pages/entry/entry.module.ts")).then(m => m.EntryPageModule) },
    { path: 'history/entry', loadChildren: () => __webpack_require__.e(/*! import() | pages-entry-entry-module */ "pages-entry-entry-module").then(__webpack_require__.bind(null, /*! ./pages/entry/entry.module */ "./src/app/pages/entry/entry.module.ts")).then(m => m.EntryPageModule) },
    { path: 'history', loadChildren: () => Promise.all(/*! import() | pages-history-history-module */[__webpack_require__.e("default~pages-history-history-module~pages-settings-setting-module"), __webpack_require__.e("pages-history-history-module")]).then(__webpack_require__.bind(null, /*! ./pages/history/history.module */ "./src/app/pages/history/history.module.ts")).then(m => m.HistoryPageModule) },
    { path: 'setting', loadChildren: () => Promise.all(/*! import() | pages-settings-setting-module */[__webpack_require__.e("default~pages-history-history-module~pages-settings-setting-module"), __webpack_require__.e("pages-settings-setting-module")]).then(__webpack_require__.bind(null, /*! ./pages/settings/setting.module */ "./src/app/pages/settings/setting.module.ts")).then(m => m.SettingPageModule) },
    { path: 'history/setting', loadChildren: () => Promise.all(/*! import() | pages-settings-setting-module */[__webpack_require__.e("default~pages-history-history-module~pages-settings-setting-module"), __webpack_require__.e("pages-settings-setting-module")]).then(__webpack_require__.bind(null, /*! ./pages/settings/setting.module */ "./src/app/pages/settings/setting.module.ts")).then(m => m.SettingPageModule) },
    { path: 'e-camera', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-camera-e-camera-module */ "pages-e-camera-e-camera-module").then(__webpack_require__.bind(null, /*! ./pages/e-camera/e-camera.module */ "./src/app/pages/e-camera/e-camera.module.ts")).then(m => m.ECameraPageModule) },
    { path: 'e-camera/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-camera-e-camera-module */ "pages-e-camera-e-camera-module").then(__webpack_require__.bind(null, /*! ./pages/e-camera/e-camera.module */ "./src/app/pages/e-camera/e-camera.module.ts")).then(m => m.ECameraPageModule) },
    { path: 'e-url', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-url-e-url-module */ "pages-e-url-e-url-module").then(__webpack_require__.bind(null, /*! ./pages/e-url/e-url.module */ "./src/app/pages/e-url/e-url.module.ts")).then(m => m.EUrlPageModule) },
    { path: 'e-url/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-url-e-url-module */ "pages-e-url-e-url-module").then(__webpack_require__.bind(null, /*! ./pages/e-url/e-url.module */ "./src/app/pages/e-url/e-url.module.ts")).then(m => m.EUrlPageModule) },
    { path: 'e-voice', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-voice-e-voice-module */ "pages-e-voice-e-voice-module").then(__webpack_require__.bind(null, /*! ./pages/e-voice/e-voice.module */ "./src/app/pages/e-voice/e-voice.module.ts")).then(m => m.EVoicePageModule) },
    { path: 'e-voice/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-voice-e-voice-module */ "pages-e-voice-e-voice-module").then(__webpack_require__.bind(null, /*! ./pages/e-voice/e-voice.module */ "./src/app/pages/e-voice/e-voice.module.ts")).then(m => m.EVoicePageModule) },
    { path: 'e-search', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-search-e-search-module */ "pages-e-search-e-search-module").then(__webpack_require__.bind(null, /*! ./pages/e-search/e-search.module */ "./src/app/pages/e-search/e-search.module.ts")).then(m => m.ESearchPageModule) },
    { path: 'e-search/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-search-e-search-module */ "pages-e-search-e-search-module").then(__webpack_require__.bind(null, /*! ./pages/e-search/e-search.module */ "./src/app/pages/e-search/e-search.module.ts")).then(m => m.ESearchPageModule) },
    { path: 'e-description', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-description-e-description-module */ "pages-e-description-e-description-module").then(__webpack_require__.bind(null, /*! ./pages/e-description/e-description.module */ "./src/app/pages/e-description/e-description.module.ts")).then(m => m.EDescriptionPageModule) },
    { path: 'e-description/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-description-e-description-module */ "pages-e-description-e-description-module").then(__webpack_require__.bind(null, /*! ./pages/e-description/e-description.module */ "./src/app/pages/e-description/e-description.module.ts")).then(m => m.EDescriptionPageModule) },
    { path: 'e-barcode', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-barcode-e-barcode-module */ "pages-e-barcode-e-barcode-module").then(__webpack_require__.bind(null, /*! ./pages/e-barcode/e-barcode.module */ "./src/app/pages/e-barcode/e-barcode.module.ts")).then(m => m.EBarcodePageModule) },
    { path: 'e-barcode/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-e-barcode-e-barcode-module */ "pages-e-barcode-e-barcode-module").then(__webpack_require__.bind(null, /*! ./pages/e-barcode/e-barcode.module */ "./src/app/pages/e-barcode/e-barcode.module.ts")).then(m => m.EBarcodePageModule) },
];
...
/* harmony import */ var _ionic_native_speech_recognition_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/speech-recognition/ngx */ "./node_modules/@ionic-native/speech-recognition/ngx/index.js");
...
/* harmony import */ var _pages_historydate_historydate_page__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./pages/historydate/historydate.page */ "./src/app/pages/historydate/historydate.page.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"],
            _pages_historydate_historydate_page__WEBPACK_IMPORTED_MODULE_17__["HistoryDatePage"]],
        ...
        providers: [
            ...
            _ionic_native_speech_recognition_ngx__WEBPACK_IMPORTED_MODULE_15__["SpeechRecognition"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HistoryDatePage", function() { return HistoryDatePage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let HistoryDatePage = class HistoryDatePage {
    constructor(router, logService, afs, modalController) {
        this.router = router;
...
HistoryDatePage.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services_log_service__WEBPACK_IMPORTED_MODULE_3__["LogService"] },
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestore"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["ModalController"] }
];
HistoryDatePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-historydate',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./historydate.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/historydate/historydate.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./historydate.page.scss */ "./src/app/pages/historydate/historydate.page.scss")).default]
    }),
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _model_log__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/log */ "./src/app/model/log.ts");
...
let LogService = class LogService {
    constructor(afStorage, afs, loadingController) {
        ...
        this.data.entries = [];
        firebase_app__WEBPACK_IMPORTED_MODULE_6__["auth"]().signInAnonymously();
    ...
    remove(docId) {
        ...
        tmpCol.doc('--last--').get().toPromise().then(doc => {
            if (doc.data().id === docId) {
                // deleting last document
                var targetID = '';
                tmpCol.get().toPromise().then(snapshot => {
    ...
    push(callback = null) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            loading.present();
            this.logsCollection.add({ date: new Date(), platform: this.data.platform, contextLogged: false, entries: [] }).then(doc => {
                const docId = doc.id;
                ...
                this.data.entries.forEach(element => {
                    ...
                    if (element['entry'] === 'base64_img') {
                        const fileName = docId + '_' + fileCounter.toString();
                        fileCounter++;
                        const task = this.afStorage.ref(this.username + '/' + fileName).putString(element['data'], 'data_url');
                        fileCounter++;
                        const t = task.snapshotChanges().toPromise().then((state) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                            const downloadURL = yield this.afStorage.ref(this.username + '/' + fileName).getDownloadURL().toPromise();
                            this.logsCollection.doc(docId).set({ ['entries']: firebase_app__WEBPACK_IMPORTED_MODULE_6__["firestore"].FieldValue.arrayUnion({ modality: 'foodImg', entry: fileName, url: downloadURL }) }, { merge: true });
                        }));
                        promises.push(t);
                        ...
                        const t = this.logsCollection.doc(docId).set({ ['entries']: firebase_app__WEBPACK_IMPORTED_MODULE_6__["firestore"].FieldValue.arrayUnion({ modality: mod, entry: element['entry'] }) }, { merge: true });
                        promises.push(t);
                    }
                });
...
module.exports = __webpack_require__(/*! /Users/yuqihuai/Documents/GitHub/multimodal-food-apps/mobile v2/src/main.ts */"./src/main.ts");

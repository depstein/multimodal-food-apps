...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-e-voice-e-voice-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesEVoiceEVoicePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesEVoiceEVoiceModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EVoicePageModule", function () {
    ...
    var _e_voice_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./e-voice.page */
    ...
    var EVoicePageModule = function EVoicePageModule() {
      _classCallCheck(this, EVoicePageModule);
    };

    EVoicePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesEVoiceEVoicePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesEVoiceEVoicePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EVoicePage", function () {
      return EVoicePage;
    });
    /* harmony import */
    ...
    var _ionic_native_speech_recognition_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function () {
      function EVoicePage(speechRecognition, router, logService, changeDetectorRef, route) {
        _classCallCheck(this, EVoicePage);
          ...
          this.speechRecognition.hasPermission().then(function (permission) {
            ...
            if (!permission) {
              _this.speechRecognition.requestPermission().then(function () {
                return _this.isAvailable = true;
              }, function () {
                return _this.isAvailable = false;
              });
            }
          });
        }
            ...
            if (this.isRecording) {
              ...
              this.speechRecognition.startListening({
                ...
                matches.forEach(function (item) {
                  return _this2.matches.push(item);
                });
                _this2.result = matches[0];
    ...
    EVoicePage.ctorParameters = function () {
      return [{
    ...
    EVoicePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-e-voice',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./e-voice.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/e-voice/e-voice.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./e-voice.page.scss */
      "./src/app/pages/e-voice/e-voice.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_speech_recognition_ngx__WEBPACK_IMPORTED_MODULE_2__["SpeechRecognition"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], src_app_services_log_service__WEBPACK_IMPORTED_MODULE_4__["LogService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])], EVoicePage);
    /***/
  }
}]);
//# sourceMappingURL=pages-e-voice-e-voice-module-es5.js.map